...
<body>
    <div class="container">
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav class="d-inline-flex mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 text-light text-decoration-none btn btn-primary btn-sm" href="index.php">Home Page</a>
        ...
        <div class="row">
            ...
            <center>
            <span id="val"></span><br>
            <a class="me-3 py-2 text-light text-decoration-none btn btn-primary btn-sm" href="index.php">Check Out</a>
       <script>
           ...
           document.getElementById("val").innerHTML = "Total Cost = " + sumVal;
           console.log(sumVal);
